...
const Reviews = ({ restaurantId, orderId }) => {
  ...
  const renderRatingDistribution = () => {
    ...
    return <div style={styles.distribution}>{distribution}</div>;
  };
        ...
        <div className="card" style={styles.reviewForm}>
          ...
          <form onSubmit={handleSubmitReview}>
            ...
            <div className="input-group">
              ...
              {renderStars(reviewForm.foodRating, true, (rating) =>
                setReviewForm({ ...reviewForm, foodRating: rating })
              )}
            </div>

            <div className="input-group">
              <label>Delivery Experience</label>
              {renderStars(reviewForm.deliveryRating, true, (rating) =>
                setReviewForm({ ...reviewForm, deliveryRating: rating })
              )}
            </div>
